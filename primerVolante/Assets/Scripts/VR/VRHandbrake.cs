...
namespace PrimerVolante.VR
{
    ...
    public class VRHandbrake : MonoBehaviour
    {
        ...
        /// </summary>
        public float Engagement => 1f - Mathf.Clamp01(GetLoweredAngle() / releaseAngleRange);

        /// <summary>
        /// Indica si el freno de mano no está completamente liberado.
        /// </summary>
        public bool IsEngaged => (releaseAngleRange - GetLoweredAngle()) > m_ReleaseThresholdDegrees;
